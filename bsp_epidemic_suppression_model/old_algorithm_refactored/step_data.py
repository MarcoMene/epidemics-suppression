...
class StepData:
    ...
    tildepgs: List[float]  # Probabilities that a source infected at t has each severity
    EtauC_relative_time_units: float  # Expected contagion time for source infected at t
    EtauC_in_days: float  # Expected contagion time for source infected at t, in days
    ...
    tildetauTapp: DiscreteDistributionOnNonNegatives
    # Distribution of testing time for source infected at t with app
    tildetauTnoapp: DiscreteDistributionOnNonNegatives
