...
fraction_symptomatics = 0.6  # Proportion of individuals who are symptomatics. Source: https://science.sciencemag.org/highwire/markup/744126/expansion?width=1000&height=500&iframe=true&postprocessors=highwire_figures%2Chighwire_math%2Chighwire_embed
...
R0sy = sy_contr_to_R / fraction_symptomatics * R0
R0asy = (1 - sy_contr_to_R) / (1 - fraction_symptomatics) * R0
